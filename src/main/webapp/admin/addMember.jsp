		...
		<div class="container">
			<div class="card">
				<div class="text-center">
					<h3 class="heading" style="color: #1e90ff;">Add Member</h3>
				</div>
				<br>
				<form action="AddMemberServlet" method="post"
					...
					<div class="form-group">
						<label for="inputAddress">Gender</label><br> <input
					...
					<div class="form-group">
						<label for="exampleFormControlInput1">Joining Date</label> <input
							type="date" id="entrydate" name="joindate"
